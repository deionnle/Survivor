...
public class MaxDiscountTest {
    ...
    public void referenceTest() {
        ...
        assertEquals(450, MaxDiscount.getMaxDiscount(7,price));
    }

    @Test
    public void bigTest() {
        int[] price = new int[] {450,600,300,650,100,50,500,300,150,90,800};
        assertEquals(1000, MaxDiscount.getMaxDiscount(11,price));
    }

    @Test
    public void twelveTest() {
        int[] price = new int[] {450,600,300,70,650,100,50,500,300,150,90,800};
        assertEquals(1050, MaxDiscount.getMaxDiscount(12,price));
    }

    @Test
    public void threeTest() {
        int[] price = new int[] {450,600,300};
        assertEquals(300, MaxDiscount.getMaxDiscount(3,price));
    }

    @Test
    public void zeroTest() {
        int[] price = new int[] {600,300};
        assertEquals(0, MaxDiscount.getMaxDiscount(2,price));
    }

    @Test
    public void onePriceTest() {
        int[] price = new int[] {300};
        assertEquals(0, MaxDiscount.getMaxDiscount(1,price));
    }
    ...
    public void random1000Test() {
        ...
        assertEquals(MaxDiscount.getMaxDiscount(N,prices),MaxDiscount.getMaxDiscount(N,prices));
    }
}