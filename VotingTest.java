...
public class VotingTest {
    ...
    public void referenceTest() {
        ...
        assertEquals("majority winner 1", Voting.getVotingResult(N,Votes));
    }
    ...
    public void reference2Test() {
        ...
        assertEquals("minority winner 2", Voting.getVotingResult(N,Votes));
    }
    ...
    public void zeroTest () {
        int N = 3;
        int[] votes = {0,0,100};
        assertEquals("majority winner 3",Voting.getVotingResult(N,votes));
    }
    ...
    public void minorityTest () {
        ...
        assertEquals("minority winner 8",Voting.getVotingResult(N,votes));
    }
